...
<div class="wrapper">
  ...
  <nav class="main-nav" role="navigation">
	  ...
	  <ul id="main-menu" class="sm sm-blue"> 
		...
		<li><a href="#"><i data-feather="file-text"></i>Forms</a>
		  <ul>
		...
		<li><a href="#"><i data-feather="layout"></i>Table</a>
		  <ul>
						...
						<div class="box-header">
							...
							<div class="box-controls pull-right">
								<div class="btn-group ms-10">
								  <button class="btn btn-xs btn-primary-light dropdown-toggle" type="button" data-bs-toggle="dropdown">Show All</button>
								  <div class="dropdown-menu">
									<a class="dropdown-item" href="#">Three Month</a>
									<a class="dropdown-item" href="#">Six Month</a>
									<a class="dropdown-item" href="#">Last One Year</a>
  ...
  <footer class="main-footer">
    <div class="pull-right d-none d-sm-inline-block">
	  ...
	  &copy; <script>document.write(new Date().getFullYear())</script> <a href="https://axcelworld.com/">AXCEL</a>. All Rights Reserved.
  </footer>
